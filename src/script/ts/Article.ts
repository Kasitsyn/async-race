...
export class Article implements IArticle {
  ...
  generateArticle() {
    ...
    <article class="article ">
      ...
      <div class="racing">  
        <svg id="car-img" class="article__img" data-id="${this.id}" fill=${this.color} width="100" height="50" viewBox="0 0 50 50" xmlns="http://www.w3.org/2000/svg" aria-labelledby="title"
...
export class WinnerLine {
  ...
  generateLine() {
    ...
    let template = `
    <tr>
      <td id="winner-line-id">${this.id}</td>
      <td id="winner-line-img">
      <svg id="car-img" class="article__img" fill=${this.color} width="50" height="25" viewBox="0 0 50 50" xmlns="http://www.w3.org/2000/svg" aria-labelledby="title"
        aria-describedby="desc" role="img" xmlns:xlink="http://www.w3.org/1999/xlink">
        <path stroke-width="2"
        stroke-linejoin="round" stroke-linecap="round" stroke="#202020" 
        d="M9.011 41H3s.023-4.814.368-8.32a37.433 37.433 0 0 1 4.369-12.12A3.908 3.908 0 0 1 10.444 19H36.27l8.856 8s10.722 1.5 13.688 1.728c3.454.271 3.176 2.894 3.176 2.894s-.364 3.917-.624 5.841S60.047 41 58.357 41H55m-12 0H21.011m24.131-14.006H4.867"
      ...
      <td id="winner-line-name">${this.name}</td>
      <td id="winner-line-time">${this.time}</td>
    </tr>
    `
    if (table) table.innerHTML += template
  }
